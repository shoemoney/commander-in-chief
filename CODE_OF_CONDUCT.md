...
```mermaid
flowchart LR
    A["📮 Report<br/>jeremy@shoemoney.com"] --> B["🔍 Review<br/>prompt + fair"]
    B --> C{"⚖️ Impact?"}
    C -->|"1️⃣ minor"| D["✏️ Correction<br/>private written warning"]
    C -->|"2️⃣ one incident<br/>or series"| E["⚠️ Warning<br/>+ no-contact period"]
    C -->|"3️⃣ sustained<br/>or serious"| F["⏳ Temporary ban<br/>time-limited"]
    C -->|"4️⃣ pattern<br/>or severe"| G["🚫 Permanent ban"]
```
...
<details><summary>⚖️ <b>Contributor Covenant v2.1 — source & license</b></summary>
