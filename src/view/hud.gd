...
func _draw_caption() -> void:
	...
	# MERGE NOTE: every alpha here stays multiplied by `a`. The AAA-polish branch
	# introduced this soft scrim with FLAT alphas (0.5 / 0.9 / 0.45), which would have
	# left the backing plate and keyline at full strength while the caption text itself
