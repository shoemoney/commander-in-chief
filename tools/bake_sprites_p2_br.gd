...
##   cp -R "$SRC/Assets" "$SRC/project.godot" /tmp/legacy-art-bake-p2/br/
...
func _initialize() -> void:
	...
	jobs = [
		{"name": "pickup_vest", "src": PU + "SM_PickUp_Armor_01.tscn", "kind": "obj", "px": 56},
		{"name": "tank_hulk", "src": VE + "SM_Veh_Tank_USA_Destroyed_01.tscn", "kind": "obj", "px": 104},
	]
