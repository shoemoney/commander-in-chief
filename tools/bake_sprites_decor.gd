...
func _initialize() -> void:
	...
	jobs = [
		...
		{"name": "landmine", "src": PR + "Military/SM_Prop_Mine_01.tscn", "kind": "obj", "px": 160},
		# "crate_stack" EXCLUDED: Crate_Ammo_02 is a single crate; shipped sprite is a hand-arranged 3-stack — original ad-hoc bake kept.
		{"name": "barbedwire", "src": PR + "Military/SM_Prop_RazorWire_01.tscn", "kind": "obj", "px": 220},
		# "barrier" EXCLUDED: Tent_Sandbags_01 reads as a tent structure; shipped sprite is a sandbag mound — original ad-hoc bake kept.
		{"name": "rock1", "src": EN + "SM_Env_Rock_01.tscn", "kind": "obj", "px": 220},
		{"name": "rock2", "src": EN + "SM_Env_Rock_02.tscn", "kind": "obj", "px": 260},
		{"name": "tent", "src": BL + "SM_Bld_CamoNet_Tent_01.tscn", "kind": "obj", "px": 260},
		# "watchtower" EXCLUDED: GuardTower_01 from straight top-down is all roof; shipped bake used a tilted view — original ad-hoc bake kept.
		{"name": "wreck", "src": VE + "Destroyed/SM_Veh_APC_01_Destroyed.tscn", "kind": "obj", "px": 220},
	]
